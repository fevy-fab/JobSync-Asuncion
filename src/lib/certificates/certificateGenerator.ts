...
export function getTemplateMetadata(template: CertificateTemplate) {
  const metadata = {
    ...
    modern: {
      ...
      description: 'Clean, contemporary design with blue gradient',
      colorScheme: 'Blue Gradient on White',
      orientation: 'Landscape',
      style: 'Contemporary',
    },
    government: {
    ...
    colorful: {
      ...
      description: 'Vibrant, celebratory design with multi-color elements',
      colorScheme: 'Purple, Pink & Orange',
      orientation: 'Landscape',
      style: 'Celebratory',
    },
    professional: {
      name: 'Professional Business',
      description: 'Corporate minimal style with left-aligned layout',
      colorScheme: 'Teal & Gray on White',
      orientation: 'Landscape',
      style: 'Corporate',
    },
  };
